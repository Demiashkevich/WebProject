...
<main>
  ...
  <section  class="si-cm fade-in first"><!--Sign Input Edit Movie-->
    <form method="get">
      <ul class="si-list">
        <li class="si-item">
          <input class="form-input input-size" value="${movie.title}" type="text" name="title" placeholder="<fmt:message key="create.movie.input.title"/>" autofocus="true" tabindex="1"/>
        </li>
        <li class="si-item">
          <input class="form-input input-size" value="${movie.date}" type="date" name="date" placeholder="<fmt:message key="create.movie.input.date"/>" tabindex="2">
        </li>
        <li class="si-item">
          <textarea class="form-input input-size textarea-input" name="description" placeholder="<fmt:message key="create.movie.input.description"/>" tabindex="3">${movie.description}</textarea>
        </li>
        <li class="si-item">
          <input class="form-input input-size" value="${movie.length}" type="number" name="length" placeholder="<fmt:message key="create.movie.input.length"/>" tabindex="4"/>
        </li>
        <li class="si-item">
